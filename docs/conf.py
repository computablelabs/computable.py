# -*- coding: utf-8 -*-
#
# computable.py documentation build configuration file
#
...
project = u'computable.py'
copyright = u'2019, Computable'
...
man_pages = [
    ('index', 'computable', u'computable.py Documentation',
     [u'Computable'], 1)
]
...
texinfo_documents = [
  ('index', 'computable.py', u'computable.py Documentation',
   u'Computable', 'computable.py', 'API for Computable protocol.',
   'Miscellaneous'),
]
